...
class KvsConsumerLibrary(Thread):
    ...
    def stop_thread(self, complete_stream_if_thread_stopped: bool = False):
    ...
    def run(self):
        ...
        try:
            ...
            for chunk in kvs_streaming_buffer:
                ...
                ebml_header_elements = self._get_ebml_header_elements(
                ...
                if len(ebml_header_elements) > 1:
                    ...
                    fragment_receive_duration = (
                        timeit.default_timer() - fragment_read_start_time
                    )
            ...
            print("Not processing fragments as no more chunks in stream.")
